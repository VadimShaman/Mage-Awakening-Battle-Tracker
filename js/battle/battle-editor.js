...
export function openCharacterEditor(battleId, charId, charData) {
    ...
    if (!modalRoot) {
        alert('Контейнер модального окна не найден. Убедитесь, что в battle.html есть <div id="character-editor-modal"></div>');
        return;
    }
        ...
        <div class="modal-window">
            ...
            <div class="modal-section">
                ...
                <div class="modal-grid">
                    ...
                    <div class="modal-field"><label>Мана</label>
            ...
            <div class="modal-section">
                ...
                <div class="modal-grid">
                    <div class="modal-field"><label>Сила</label>
                        <input type="number" id="ed-strength" min="1" max="10" value="${c.strength || 2}"></div>
                    <div class="modal-field"><label>Ловкость</label>
                        <input type="number" id="ed-dexterity" min="1" max="10" value="${c.dexterity || 2}"></div>
                    <div class="modal-field"><label>Выносливость</label>
                        <input type="number" id="ed-stamina" min="1" max="10" value="${c.stamina || 2}"></div>
                    <div class="modal-field"><label>Сообразительность</label>
                        <input type="number" id="ed-wits" min="1" max="10" value="${c.wits || 2}"></div>
                    <div class="modal-field"><label>Решимость</label>
                        <input type="number" id="ed-resolve" min="1" max="10" value="${c.resolve || 2}"></div>
                    <div class="modal-field"><label>Самообладание</label>
                        <input type="number" id="ed-composure" min="1" max="10" value="${c.composure || 2}"></div>
                    <div class="modal-field"><label>Внушительность</label>
                        <input type="number" id="ed-presence" min="1" max="10" value="${c.presence || 2}"></div>
                    <div class="modal-field"><label>Манипулирование</label>
                        <input type="number" id="ed-manipulation" min="1" max="10" value="${c.manipulation || 2}"></div>
                </div>
            </div>
            ...
            <div class="modal-section">
                <h4>Здоровье и бой</h4>
                <div class="modal-grid">
                    <div class="modal-field"><label>Здоровье (тек.)</label>
                        <input type="number" id="ed-health" min="-10" max="30" value="${c.health ?? 7}"></div>
                    <div class="modal-field"><label>Здоровье (макс)</label>
                        <input type="number" id="ed-maxHealth" min="1" max="30" value="${c.maxHealth ?? 7}"></div>
                    <div class="modal-field"><label>Защита</label>
                        <input type="number" id="ed-defense" min="0" max="20" value="${c.defense ?? 2}"></div>
                    <div class="modal-field"><label>Скорость</label>
                        <input type="number" id="ed-speed" min="0" max="30" value="${c.speed ?? 9}"></div>
                    <div class="modal-field"><label>Сила Воли (тек.)</label>
                        <input type="number" id="ed-willpower" min="0" max="20" value="${c.willpower ?? 4}"></div>
                    <div class="modal-field"><label>Сила Воли (макс)</label>
                        <input type="number" id="ed-maxWillpower" min="0" max="20" value="${c.maxWillpower ?? 4}"></div>
                </div>
            </div>
